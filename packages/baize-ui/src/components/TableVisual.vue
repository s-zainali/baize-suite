<template>
    ...
    <div v-else-if="isTableTennis || isPrivateTT" :style="isDisplay ? { width: '101px', height: '175px' } : {}">
        <div class="w-[202px] relative flex-none px-4" :class="isDisplay ? 'scale-50 origin-top-left' : 'mt-12'">
            ...
            <div class="flex flex-col items-center w-full relative z-10 group">
                ...
                <div class="relative w-full rounded-lg shadow-xl transition-all duration-500 h-[350px]"
                    :class="[ttTableThemeClasses, isDisplay ? 'flex items-center justify-center' : '']">
                    ...
                    <div class="inset-x-0 flex flex-col items-center px-4 pointer-events-none text-center z-10"
                        ...
                        <span v-if="isDisplay && !hideDisplayRate"
                            class="text-xl backdrop-blur-[2px] font-semibold tracking-wider text-slate-100">
                            {{ currentRate }} Rs/min
                        </span>
                    </div>
...
const isPrivatePool = computed(
    () => props.table.type && props.table.type.toLowerCase()==='privatepool',
)
const isPrivateSnooker = computed(() => props.table.type === 'privateSnooker')

const isTableTennis = computed(() => props.table.type.toLowerCase() == 'tabletennis')
const isPrivateTT = computed(() => props.table.type.toLowerCase() == 'privatetabletennis')
