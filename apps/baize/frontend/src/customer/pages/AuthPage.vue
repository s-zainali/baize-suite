        ...
        <div class="relative flex min-h-screen items-center justify-center p-4 py-8">
            <div class="w-full max-w-[380px]">
                ...
                <div class="mb-7 text-center">
                    <div class="mb-3.5 inline-flex items-center justify-center">
                        <img :src="API_URL + branding.logoUrl" class="h-15" alt="">
                    </div>
                    <h1 class="text-2xl font-black tracking-tight"> {{ branding.clubName }}</h1>
...
import { isValidPhone, maskPhone } from '@/utils/phone.js'
import PoweredByZain from '../../components/PoweredByZain.vue'
import * as customerApi from '../api.js'
import { branding, loadBranding } from '@/composables/useLicense.js'
...
onMounted(updateScrollEdges, loadBranding())
watch(mode, () => nextTick(() => {
